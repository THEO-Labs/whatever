            ...
            <View style={styles.container}>
                ...
                <View style={styles.progressBar}>
                    {[0, 1, 2, 3, 4, 5, 6].map(i => (
                        <View
                            ...
                            style={[
                                styles.progressDot,
                                i === 1 && styles.progressDotActive, // ← Step 2
                            ]}
                        />
                    ))}
                </View>
                ...
                <View style={styles.unitSwitch}>
                    <TouchableOpacity
                        ...
                        style={[
                            styles.unitOption,
                            unit === 'lb' && styles.unitActive,
                        ]}>
                        <Text style={unit === 'lb' ? styles.unitTextActive : styles.unitText}>lb</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => setUnit('kg')}
                        style={[
                            styles.unitOption,
                            unit === 'kg' && styles.unitActive,
                        ]}>
                        <Text style={unit === 'kg' ? styles.unitTextActive : styles.unitText}>kg</Text>
                    </TouchableOpacity>
                </View>
